...
This repository collects pipeline, code, and some intermediate results for the study of mosaic SNV/Indels for sperm, blood, and saliva samples of a small cohort. Raw WGS data of this study are available [here](https://trace.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA753973&o=acc_s%3Aa). Genotyping results of each sample is provided [here](https://github.com/shishenyxx/Sperm_transmission_mosaicism/blob/main/Analysis/Genotyping_in_different_samples.csv). Re-analysis of the transmission of paternal mosaic variants from the ASD trios is provided [here](https://github.com/shishenyxx/Sperm_transmission_mosaicism/blob/main/Analysis/Genotyping_ASD_trios.csv). 300x WGS panel of normal are available [here](https://trace.ncbi.nlm.nih.gov/Traces/study/?acc=PRJNA660493&o=acc_s%3Aa).
